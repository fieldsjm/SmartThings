 ...
 */
metadata {
	definition (name: "Simulated Garage Door Opener w/ Camera (Custom)", namespace: "SmartThings", author: "fieldsjm", vid: "generic-contact-4", ocfdevicetype: "oic.d.garagedoor", mnmn: "SmartThings") {
		capability "Actuator"
